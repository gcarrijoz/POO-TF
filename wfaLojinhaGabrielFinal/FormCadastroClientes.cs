    ...
    public partial class FormCadastroClientes : Form
    {
        ...
        private void btCadastrarCliente_Click(object sender, EventArgs e)
        {
            ...
            if (recebeValidacao == true)
            {
                ...
                string stringSql = "INSERT INTO Clientes(nome_cliente, sobrenome_cliente, email_cliente, celular_cliente)" +
                        $"VALUES('{objCliente.NomeCliente}', '{objCliente.SobrenomeCliente}', '{objCliente.EmailCliente}', '{objCliente.CelularCliente}')";
                ...
                MessageBox.Show("Cliente Cadastrado com Sucesso!", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
